...
var xmtpJs = require('@relaycc/xmtp-js');
...
var useResponsiveName = function (ensName, address, fallback) {
    var userDisplayId = React.useMemo(function () {
        return ensName || address;
    }, [ensName, address]);
    var responsiveDisplayId = React.useMemo(function () {
        if (!userDisplayId) {
            return fallback;
        }
        if (ensName) {
...
var useReceiver = create__default["default"](function (set, get) { return ({
    wallet: null,
...
var useSetWallet = function () {
    ...
    return React.useCallback(function (wallet) {
        setWallet(wallet);
    }, []);
};
...
var useRelay = create__default["default"](function (set, get) { return ({
    client: null,
    stream: null,
    channels: {},
    statuses: {},
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, xmtpJs.Client.create(wallet, { env: 'production' })];
            case 1:
                client = _b.sent();
...
var fetchMessages = function (client, peerAddress, limit, direction) {
    ...
    if (direction === void 0) { direction = proto.messageApi.SortDirection.SORT_DIRECTION_DESCENDING; }
    return __awaiter(void 0, void 0, void 0, function () {
...
var useLaunch = function (wallet) {
    ...
    return React.useCallback(function (handle) {
...
var provider = new providers.AlchemyProvider('homestead', 'kmMb00nhQ0SWModX6lJLjXy_pVtiQnjx');
...
var useEnsAddress = function (_a) {
    ...
    var _b = React.useState((handle && getAddress(handle)) || {
        address: undefined,
        status: 'noop',
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        result = address === null
                            ...
                            : { status: 'settled', address: utils.getAddress(address) };
        ...
        var fetchAddress = function (handle) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        setState({ status: 'fetching', address: undefined });
                        return [4 /*yield*/, graphqlRequest.request('https://api.lens.dev', profileByHandleQuery, {
                    ...
                    case 1:
                        ...
                        if (profile === null) {
                            ...
                            setState({
                                status: 'settled',
                                address: utils.getAddress(profile.ownedBy),
                            });
                        }
                        return [2 /*return*/];
                }
...
var profileByHandleQuery = graphqlRequest.gql(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  query Profile($request: SingleProfileQueryRequest!) {\n    profile(request: $request) {\n      handle\n      ownedBy\n    }\n  }\n"], ["\n  query Profile($request: SingleProfileQueryRequest!) {\n    profile(request: $request) {\n      handle\n      ownedBy\n    }\n  }\n"])));
var templateObject_1;

var useEnsAvatar = function (_a) {
    var handle = _a.handle;
    var provider = useProvider();
    var _b = React.useState((handle && getEnsAvatar(handle)) || {
        avatar: undefined,
        status: 'noop',
    }), state = _b[0], setState = _b[1];
    React.useEffect(function () {
...
var InfoCard = function (_a) {
    ...
    if (variant === 'invalid ENS') {
        return (React__default["default"].createElement("div", { className: "InfoCard FullMiddleSection" },
            React__default["default"].createElement("div", { className: "InfoCard CardContainer" },
                React__default["default"].createElement("div", { className: "InfoCard Title" }, "Could not resolve ENS name"),
                React__default["default"].createElement("div", { className: "InfoCard Text" }, 'Make sure to include the ".eth" suffix.')),
            React__default["default"].createElement(BrandedFooter, null)));
    }
    else if (variant === 'no wallet') {
        return (React__default["default"].createElement("div", { className: "InfoCard FullMiddleSection" },
            React__default["default"].createElement("div", { className: "InfoCard CardContainer" },
                React__default["default"].createElement("div", { className: "InfoCard Title" }, "Please connect a wallet"),
                React__default["default"].createElement("div", { className: "InfoCard Text" }, "To sign in to XMTP, you will need a connected wallet first.")),
            React__default["default"].createElement(BrandedFooter, null)));
    }
    else if (variant === 'no peer') {
        return (React__default["default"].createElement("div", { className: "InfoCard FullMiddleSection" },
            React__default["default"].createElement("div", { className: "InfoCard CardContainer" },
                React__default["default"].createElement("div", { className: "InfoCard Title" }, "User not on network"),
                React__default["default"].createElement("div", { className: "InfoCard Text" }, "This user is not on the XMTP messaging network yet.")),
            React__default["default"].createElement(BrandedFooter, null)));
    }
    else if (variant === 'no xmtp client') {
        return (React__default["default"].createElement("div", { className: "InfoCard FullMiddleSection" },
            React__default["default"].createElement("div", { className: "InfoCard CardContainer" },
                React__default["default"].createElement("div", { className: "InfoCard Title" }, "Initialize XMTP Client"),
                React__default["default"].createElement("div", { className: "InfoCard Text" }, "To begin messaging, you must first initialize the XMTP client."),
                React__default["default"].createElement("div", { className: "InfoCard Button", onClick: function () { return wallet && dispatch({ id: 'sign in', wallet: wallet }); } }, "Initialize")),
            React__default["default"].createElement(BrandedFooter, null)));
    }
        ...
        return (React__default["default"].createElement("div", { className: "InfoCard FullMiddleSection" },
            React__default["default"].createElement("div", { className: "InfoCard CardContainer" },
                React__default["default"].createElement("div", { className: "InfoCard Title" }, "Initialize XMTP Client"),
                React__default["default"].createElement("div", { className: "InfoCard Text" },
                    React__default["default"].createElement("b", null, "Initializing.")),
                React__default["default"].createElement("div", { className: "InfoCard Text" }, "To continue, please sign the wallet prompt."),
                React__default["default"].createElement("button", { className: "InfoCard Button Disabled" }, "Waiting...")),
            React__default["default"].createElement(BrandedFooter, null)));
    }
        ...
        return (React__default["default"].createElement("div", { className: "InfoCard FullMiddleSection" },
            React__default["default"].createElement("div", { className: "InfoCard CardContainer" },
                ...
                React__default["default"].createElement("div", { className: "InfoCard Text" },
                    React__default["default"].createElement("b", null, "Initializing.")),
                React__default["default"].createElement("div", { className: "InfoCard Text" }, "Signature request cancelled. Try again..."),
                React__default["default"].createElement("div", { className: "InfoCard Button", onClick: function () { return wallet && dispatch({ id: 'sign in', wallet: wallet }); } }, "Initialize")),
            React__default["default"].createElement(BrandedFooter, null)));
    }
        ...
        return (React__default["default"].createElement("div", { className: "InfoCard FullMiddleSection" },
            React__default["default"].createElement("div", { className: "InfoCard CardContainer" },
                React__default["default"].createElement("div", { className: "InfoCard Title" }, 'All Set  🎉'),
                React__default["default"].createElement("div", { className: "InfoCard Text" }, "This is the beginning of your encrypted conversation with ".concat(peerName)))));
    }
    else if (variant === 'new conversation') {
        return (React__default["default"].createElement("div", { className: "InfoCard FullMiddleSection" },
            React__default["default"].createElement("div", { className: "InfoCard CardContainer" },
                React__default["default"].createElement("div", { className: "InfoCard Text" }, "Only those who have previously signed into the XMTP network are reachable.")),
            React__default["default"].createElement(BrandedFooter, null)));
    }
    else {
...
var BrandedFooter = function () {
    return (React__default["default"].createElement("footer", { className: "InfoCard Footer" },
        React__default["default"].createElement("a", { className: "InfoCard FooterLink", href: "https://try.relay.cc", target: "_blank", rel: "noreferrer" },
        ...
        React__default["default"].createElement("a", { className: "InfoCard FooterLink", href: "https://docs.relay.cc/relay/relay-receiver/overview", target: "_blank", rel: "noreferrer" },
            React__default["default"].createElement("h3", { className: "InfoCard WordMark" }, "Relay Receiver"))));
};

var NewConversation$1 = function (_a) {
    var onClickCreate = _a.onClickCreate;
    var _b = React.useState(''), peerAddress = _b[0], setPeerAddress = _b[1];
    var _c = React.useState(false), isError = _c[0], setisError = _c[1];
    return (React__default["default"].createElement("div", { className: "NewConversation NewMessage" },
        React__default["default"].createElement("form", { className: "NewConversation Form", onSubmit: function (e) {
                e.preventDefault();
            ...
            isError && (React__default["default"].createElement("span", { className: "NewConversation ErrorMessage" }, "Please enter a valid handle...")),
            React__default["default"].createElement("input", { className: "NewConversation Input", autoFocus: true, placeholder: "Enter an ENS name, Lens handle, or ETH address...", type: "text", value: peerAddress, onChange: function (e) {
                    setisError(false);
                    setPeerAddress(e.currentTarget.value);
                } }),
            React__default["default"].createElement("button", { className: "NewConversation Button", type: "submit" }, "Create a New Conversation")),
        React__default["default"].createElement(InfoCard, { variant: 'new conversation' })));
};

function LoadingSpinner(props) {
    var height = props.height, width = props.width;
    return (React__default["default"].createElement("div", { className: "LoadingSpinner" },
        React__default["default"].createElement("img", { src: 'https://relay-receiver-prod.s3.amazonaws.com/MobileLoadingSpinner.png', alt: "loading", width: width, height: height })));
}
...
var Avatar = function (_a) {
    ...
    if (avatar.status === 'fetching') {
        return React__default["default"].createElement(LoadingSpinner, { width: large ? 50 : 40, height: large ? 50 : 40 });
    }
    else if (!avatar.avatar) {
        return (React__default["default"].createElement("div", { className: "Avatar BlockiesContainer large-".concat(large), onClick: onClick },
            React__default["default"].createElement(Blockies__default["default"], { seed: handle || 'no address', size: 10, scale: large ? 5 : 4, className: 'circle' })));
    }
    else {
        return (React__default["default"].createElement("img", { className: "Avatar AvatarImage large-".concat(large), onClick: onClick, src: avatar.avatar, alt: "user" }));
    }
};
...
var ConversationListItem = function (_a) {
    ...
    return (React__default["default"].createElement("li", { className: "ConversationListItem ListItem", onClick: function () {
            return dispatch({
                id: 'go to screen',
                screen: { id: 'messages', peerAddress: peerAddress },
            });
        } },
        React__default["default"].createElement(Avatar, { handle: peerAddress, onClick: function () { return null; } }),
        React__default["default"].createElement("div", { className: "ConversationListItem TextContainer" },
            React__default["default"].createElement("span", { className: "ConversationListItem Title" }, responsiveName),
            React__default["default"].createElement("span", { className: "ConversationListItem Subtitle" }, subtitle))));
};
...
var ConversationList = function () {
    ...
    if (client === null || conversationList === undefined) {
        ...
        return (React__default["default"].createElement("ul", { className: "ConversationList List" }, byMostRecentMessage(conversationList)
            .map(function (i) { return i; })
            .reverse()
            .map(function (message) { return (React__default["default"].createElement(ConversationListItem, { key: pickPeerAddress(client.address, message), peerAddress: pickPeerAddress(client.address, message), subtitle: message.content })); })));
    }
};

var LoadingList = function () {
    var divScrollToRef = React.useRef(null);
    React.useEffect(function () {
        if (!divScrollToRef.current)
            return;
        divScrollToRef.current.scrollIntoView({ behavior: 'smooth' });
    }, []);
    return (React__default["default"].createElement("div", { className: "MainContainer LoadingList" },
        React__default["default"].createElement("div", { className: "LoadingList LeftContainer" },
            React__default["default"].createElement("div", { className: "LoadingList LeftUserInfo" },
                React__default["default"].createElement("div", { className: "LoadingList LogoOutline" }),
                React__default["default"].createElement("div", { className: "LoadingList NameOutline" }),
                React__default["default"].createElement("div", { className: "LoadingList DateOutline" })),
            React__default["default"].createElement("div", { className: "LoadingList LeftMessageContainer" },
                React__default["default"].createElement("div", { className: "LoadingList FirstMessage" }),
                React__default["default"].createElement("div", { className: "LoadingList SecondMessage" }))),
        React__default["default"].createElement("div", { className: "LoadingList RightContainer" },
            React__default["default"].createElement("div", { className: "LoadingList RightUserInfo" },
                React__default["default"].createElement("div", { className: "LoadingList LogoOutline" }),
                React__default["default"].createElement("div", { className: "LoadingList NameOutline" }),
                React__default["default"].createElement("div", { className: "LoadingList DateOutline" })),
            React__default["default"].createElement("div", { className: "LoadingList RightMessageContainer" },
                React__default["default"].createElement("div", { className: "LoadingList FirstMessage" })))));
};

var MessageBubble = function (_a) {
    var message = _a.message;
    return (React__default["default"].createElement("div", { className: "MessageBubble TextWrapper" },
        React__default["default"].createElement("div", { className: "MessageBubble MessageText" }, message)));
};
...
function MessagesBucket(_a) {
    ...
    if (messages.length === 0)
        return null;
    return (React__default["default"].createElement("div", { className: "MessagesBucket Container" },
        React__default["default"].createElement("div", { className: "MessagesBucket SentByInfo" },
            React__default["default"].createElement("div", { className: "MessagesBucket MessageHeader" },
                React__default["default"].createElement("div", { style: { marginRight: '10px' } },
                    React__default["default"].createElement(Avatar, { handle: sentByAddress, onClick: function () { return null; } })),
                React__default["default"].createElement("div", { className: "MessagesBucket SenderName black-".concat(sentByMe, " white-").concat(sentByMe) }, responsiveName),
                React__default["default"].createElement("div", { className: "MessagesBucket MessageTime" }, shortDate(startDate) + ', ' + time(startDate)))),
        React__default["default"].createElement("div", { className: "MessagesBucket FlexColReverseContainer" }, messages.map(function (e) {
            return (React__default["default"].createElement("div", { className: "MessagesBucket MessagePosition", key: e.id },
                React__default["default"].createElement(MessageBubble, { message: e.content })));
        }))));
}
...
var MessageList = function (_a) {
    ...
    if (channel !== undefined && client !== null) {
        var buckets = getMessageBuckets(byMostRecentMessage(channel)
            .map(function (i) { return i; })
            .reverse());
        return (React__default["default"].createElement("div", { className: "MessageList List" }, buckets.map(function (bucket, index) {
            if (bucket.length > 0) {
                return (React__default["default"].createElement(MessagesBucket, { key: index, messages: bucket, userPeerAddress: client.address, startDate: bucket[bucket.length - 1].sent, peerName: peerAddress, sentByAddress: bucket[0].senderAddress }));
            }
            return null;
        })));
    }
...
var MessageInput = function (_a) {
    ...
    var _b = React.useState(''), inputVal = _b[0], setInputVal = _b[1];
    ...
    return (React__default["default"].createElement("input", { className: "MessageInput StyledInput", placeholder: "Write a Message...", required: true, value: inputVal, onChange: handleChange, onKeyDown: handleKeyDown }));
};

var LoadingText = function () {
    return (React__default["default"].createElement("div", { className: "LoadingText LoadingCircleContainer" },
        React__default["default"].createElement("div", { className: "LoadingText LoadingCircle" }),
        React__default["default"].createElement("div", { className: "LoadingText LoadingCircle2" }),
        React__default["default"].createElement("div", { className: "LoadingText LoadingCircle3" })));
};
...
var AddressInfo = function (_a) {
    ...
    var _c = React.useState(false), didCopyToClipboard = _c[0], setDidCopyToClipboard = _c[1];
    ...
    return (React__default["default"].createElement("div", { className: "AddressInfo Container", onClick: function () {
            setIsOpen(!isOpen);
        } },
        React__default["default"].createElement(Avatar, { handle: handle, onClick: function () { return null; } }),
        React__default["default"].createElement("div", { className: "AddressInfo TextContainer" },
            primaryId === 'loading' && React__default["default"].createElement(LoadingText, null),
            primaryId === 'loading' || (React__default["default"].createElement("div", { className: "AddressInfo MainText" }, isEthAddress(primaryId) ? truncateAddress(primaryId) : primaryId)),
            secondaryId === 'loading' && React__default["default"].createElement(LoadingText, null),
            secondaryId === 'loading' || (React__default["default"].createElement("div", { className: "AddressInfo SubText" }, truncateAddress(secondaryId))),
            React__default["default"].createElement("div", { className: "AddressInfo DropdownMenu" },
                React__default["default"].createElement("li", { className: "AddressInfo DropdownItem", onClick: function () {
                    ...
                    React__default["default"].createElement(CopyClipboardIcon, null)),
                React__default["default"].createElement("li", { className: "AddressInfo DropdownItem" },
                    React__default["default"].createElement("a", { className: "AddressInfo LiLink", href: 'https://relay.cc/' + secondaryId, target: "_blank", rel: "noreferrer" },
                        "Relay",
                        React__default["default"].createElement(GoToRelayIcon, null))),
                React__default["default"].createElement("li", { className: "AddressInfo DropdownItem" },
                    React__default["default"].createElement("a", { className: "AddressInfo LiLink", href: 'https://etherscan.io/address/' + secondaryId, target: "_blank", rel: "noreferrer" },
                        "Etherscan",
                        React__default["default"].createElement(EtherscanIcon, null)))))));
};
var CopyClipboardIcon = function () {
    return (React__default["default"].createElement("svg", { style: { paddingRight: '2px' }, xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", height: '24px', width: '24px' },
        React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v0a.75.75 0 01-.75.75H9a.75.75 0 01-.75-.75v0c0-.212.03-.418.084-.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185V19.5a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 19.5V6.257c0-1.108.806-2.057 1.907-2.185a48.208 48.208 0 011.927-.184" })));
};
var GoToRelayIcon = function () {
    return (React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", height: '24px', width: '24px' },
        React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" })));
};
...
var ExitIcon = function (_a) {
    ...
    return (React__default["default"].createElement("svg", { style: { marginLeft: marginLeft, marginRight: marginRight, padding: '0', cursor: 'pointer' }, onClick: onClick, xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", height: 28, width: 28 },
...
var GoToConversationsIcon = function (_a) {
    var onClick = _a.onClick, marginLeft = _a.marginLeft, marginRight = _a.marginRight;
    return (React__default["default"].createElement("svg", { style: { marginRight: marginRight, marginLeft: marginLeft, padding: '0', cursor: 'pointer' }, onClick: onClick, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", height: 28, width: 28 },
        React__default["default"].createElement("path", { fillRule: "evenodd", d: "M3 5.25a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 5.25zm0 4.5A.75.75 0 013.75 9h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 9.75zm0 4.5a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75a.75.75 0 01-.75-.75zm0 4.5a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75a.75.75 0 01-.75-.75z", clipRule: "evenodd" })));
};
var MinimizeIcon = function (_a) {
    var onClick = _a.onClick, marginLeft = _a.marginLeft, marginRight = _a.marginRight;
    return (React__default["default"].createElement("svg", { style: { marginRight: marginRight, marginLeft: marginLeft, padding: '0', cursor: 'pointer' }, onClick: onClick, xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", height: 28, width: 28 },
        React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M19.5 12h-15" })));
};
var NewConversationIcon = function (_a) {
    var onClick = _a.onClick, marginLeft = _a.marginLeft, marginRight = _a.marginRight;
    return (React__default["default"].createElement("svg", { style: { marginRight: marginRight, marginLeft: marginLeft, padding: '0', cursor: 'pointer' }, onClick: onClick, xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", height: 28, width: 28 },
        React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" })));
};
...
var Header = function () {
    ...
    if (screen.id === 'new conversation') {
        return (React__default["default"].createElement("div", { className: "Header HeaderWrapper" },
            React__default["default"].createElement(GoToConversationsIcon, { onClick: function () {
                    return dispatch({ id: 'go to screen', screen: { id: 'conversations' } });
                } }),
            React__default["default"].createElement("h1", { className: "Header Title" }, "New Conversation"),
            React__default["default"].createElement(ExitIcon, { onClick: function () {
                    setIsOpen(false);
                } })));
    }
    else if (screen.id === 'conversations') {
        return (React__default["default"].createElement("div", { className: "Header HeaderWrapper" },
            React__default["default"].createElement(NewConversationIcon, { onClick: function () {
                    return dispatch({ id: 'go to screen', screen: { id: 'new conversation' } });
                } }),
            React__default["default"].createElement("h1", { className: "Header Title" }, "Conversations"),
            React__default["default"].createElement(ExitIcon, { onClick: function () {
                    setIsOpen(false);
                } })));
    }
        ...
        return (React__default["default"].createElement("div", { className: "Header HeaderWrapper" },
            React__default["default"].createElement(GoToConversationsIcon, { marginRight: "10px", onClick: function () {
                    return dispatch({ id: 'go to screen', screen: { id: 'conversations' } });
                } }),
            React__default["default"].createElement(AddressInfo, { handle: screen.peerAddress }),
            React__default["default"].createElement(MinimizeIcon, { marginLeft: "auto", onClick: function () {
                    dispatch({
...
var Launcher = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: "Launcher Fixed" },
        React__default["default"].createElement("ul", { className: "Launcher Container" },
            React__default["default"].createElement("button", { className: "Launcher LaunchButton", onClick: onClickLaunch },
                React__default["default"].createElement(ChatIcon, null)),
            pinnedConversations.map(function (peerAddress) { return (React__default["default"].createElement("div", { className: "Launcher AvatarContainer", key: peerAddress },
                React__default["default"].createElement(Avatar, { large: true, handle: peerAddress, onClick: function () {
                        dispatchReceiver({
                            id: 'go to screen',
                            screen: { id: 'messages', peerAddress: peerAddress },
                        });
                ...
                React__default["default"].createElement("div", { className: "Launcher AvatarHoverDetails", onClick: function () {
                        dispatchReceiver({
...
var ChatIcon = function () {
    return (React__default["default"].createElement("svg", { fill: "white", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "#5203fc", height: '24px', width: '24px' },
        React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 01-.825-.242m9.345-8.334a2.126 2.126 0 00-.476-.095 48.64 48.64 0 00-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0011.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155" })));
};
var CloseIcon = function () {
    return (React__default["default"].createElement("svg", { fill: "black", viewBox: "0 0 28 28", strokeWidth: 2.5, stroke: "black", height: "28", width: "28" },
        React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M6 18L18 6M6 6l12 12" })));
};
...
var PeerAddress = function (_a) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        (function () {
            if (wallet === null) {
                return React__default["default"].createElement(InfoCard, { variant: "no wallet" });
            }
            else if (channelStatus === 'no peer') {
                return React__default["default"].createElement(InfoCard, { variant: "no peer" });
            }
            else if (signatureStatus === 'waiting') {
                return React__default["default"].createElement(InfoCard, { variant: "waiting for signature" });
            }
            else if (signatureStatus === 'denied') {
                return React__default["default"].createElement(InfoCard, { variant: "signature denied" });
            }
            else if (client === null) {
                return React__default["default"].createElement(InfoCard, { variant: "no xmtp client" });
            }
            else if (channelStatus === 'loadingFull' ||
                channelStatus === undefined) {
                return (React__default["default"].createElement(React__default["default"].Fragment, null,
                    React__default["default"].createElement(LoadingList, null),
                    React__default["default"].createElement(MessageInput, { onSendMessage: function (message) {
                ...
                isEmpty(channel)) {
                return (React__default["default"].createElement(React__default["default"].Fragment, null,
                    React__default["default"].createElement(InfoCard, { variant: "no messages" }),
                    React__default["default"].createElement(MessageInput, { onSendMessage: function (message) {
                            return client && client.sendMessage(peerAddress, message);
                        } })));
            }
                ...
                return (React__default["default"].createElement(React__default["default"].Fragment, null,
                    React__default["default"].createElement(MessageList, { peerAddress: peerAddress }),
                    React__default["default"].createElement(MessageInput, { onSendMessage: function (message) {
                            return client && client.sendMessage(peerAddress, message);
                        } })));
            }
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        (function () {
            if (wallet === null) {
                ...
                return React__default["default"].createElement(ConversationList, null);
            }
            else {
                return React__default["default"].createElement(LoadingList, null);
            }
...
var NewConversation = function () {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(Header, null),
        React__default["default"].createElement(NewConversation$1, { onClickCreate: function (peerAddress) {
                dispatch({
                    id: 'go to screen',
                    screen: { id: 'messages', peerAddress: peerAddress },
                });
...
var Window = function (_a) {
    ...
    var screen = React.useMemo(function () {
        if (visibleScreen.id === 'conversations') {
            return React__default["default"].createElement(Conversations, null);
        }
        else if (visibleScreen.id === 'messages') {
            return React__default["default"].createElement(PeerAddress, { handle: visibleScreen.peerAddress });
        }
        else if (visibleScreen.id === 'new conversation') {
            return React__default["default"].createElement(NewConversation, null);
        }
        else {
            throw new Error('Unspported screen: ' + String(screen));
        }
    }, [visibleScreen]);
    return React__default["default"].createElement("div", { className: "".concat(className, " Window Container") }, screen);
};

var AnimatePresence$1 = framerMotion.AnimatePresence;
var VARIANTS$1 = {
...
var Modal = function (_a) {
    ...
    return (React__default["default"].createElement(AnimatePresence$1, null, isActuallyOpen && (React__default["default"].createElement(framerMotion.motion.div, { className: "Modal Overlay", key: "receiver-modal", initial: ['hide', 'invisible'], animate: ['show', 'visible'], exit: ['hide', 'invisible'], variants: VARIANTS$1 }, children))));
};
...
var Intercom = function (_a) {
    ...
    var isOpenState = useIsOpen();
    var isActuallyOpen = isOpen === undefined ? isOpenState : isOpen;
    return (React__default["default"].createElement(AnimatePresence, null, isActuallyOpen && (React__default["default"].createElement(framerMotion.motion.div, { className: "Intercom Fixed ".concat('position-' + (position || 'right')), key: "receiver-modal", initial: "hide", animate: "show", exit: "hide", variants: VARIANTS }, children))));
};
...
exports.useLaunch = useLaunch;
exports.useSetWallet = useSetWallet;
